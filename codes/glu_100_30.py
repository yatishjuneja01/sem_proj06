# -*- coding: utf-8 -*-
"""
Created on Thu Feb 16 00:52:51 2023
...
for j in range(0,5):
    ...
    for i in range(1, N):
        ...
        if 210 < dt * i < 212: #initialising train stimulus
            Glu_conc[i] = 400
        elif 212 < dt * i < 220:
...
#     asynchronous[i] = asynchronous_r
    ...
    df.to_csv(r"C:\semester project\shweta\sims\glu_400_30_cyto20" + "\output" + str(j) + ".csv", index=False) #save data frame as csv
