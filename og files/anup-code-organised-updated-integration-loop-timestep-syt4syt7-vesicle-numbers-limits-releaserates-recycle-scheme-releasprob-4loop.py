...
#	 asynchronous[i] = asynchronous_r
	...
	df = pd.DataFrame({"Time": time[4000000:], "Ca_cyto": Ca_cyto[4000000:],"R_type": release[4000000:]}) #make a data frame but for values after 200s (time step 4000000)
	df.to_csv("/home/shrotri/Downloads/anup-code/test-run/18nov-scheme-wo-forcing1/sim2/" + "output" + str(j) + ".csv", index=False) #save data frame as csv
